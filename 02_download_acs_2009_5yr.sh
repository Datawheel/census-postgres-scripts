...
aria2c --dir=/acs/tmp/acs2009_5yr --max-connection-per-server=5 --force-sequential=true \
...
chmod 777 /acs/tmp/acs2009_5yr/group1 /acs/tmp/acs2009_5yr/group2
chmod 644 /acs/tmp/acs2009_5yr/group1/* /acs/tmp/acs2009_5yr/group2/*